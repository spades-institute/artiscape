    ...
    return (
        <main className="max-w-7xl mx-auto px-4 py-8">
            <section className="mb-8">
                <h1 className="text-3xl font-bold text-gray-800 mb-4">Personal Bio</h1>
                <p className="text-gray-600">{aboutData.bio}</p>
            </section>
            <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Skills and Expertise</h2>
            ...
            <section className="mb-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Awards and Recognition</h2>
                <ul className="list-disc list-inside">
